...
pub const fn message(locale: Locale, key: MessageKey) -> &'static str {
    match (locale, key) {
        ...
        (Locale::English, MessageKey::SaveGameVersion) => "GVAS save-game version",
        (Locale::SimplifiedChinese, MessageKey::SaveGameVersion) => "GVAS 存档版本",
        (Locale::English, MessageKey::PackageVersion) => "Package version (UE4 / UE5)",
        (Locale::SimplifiedChinese, MessageKey::PackageVersion) => "包版本（UE4 / UE5）",
        (Locale::English, MessageKey::EngineVersion) => "Engine version",
        (Locale::SimplifiedChinese, MessageKey::EngineVersion) => "引擎版本",
        (Locale::English, MessageKey::EngineBranch) => "Engine branch",
        (Locale::SimplifiedChinese, MessageKey::EngineBranch) => "引擎分支",
        (Locale::English, MessageKey::CustomVersions) => "Custom versions",
        (Locale::SimplifiedChinese, MessageKey::CustomVersions) => "自定义版本数量",
        (Locale::English, MessageKey::SaveGameClass) => "SaveGame class",
        (Locale::SimplifiedChinese, MessageKey::SaveGameClass) => "SaveGame 类",
        (Locale::English, MessageKey::TopLevelProperties) => "Top-level properties",
        (Locale::SimplifiedChinese, MessageKey::TopLevelProperties) => "顶层属性数量",
